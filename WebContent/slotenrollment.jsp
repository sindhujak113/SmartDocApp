...
<tr>
<td></td>
<td><input type="button" name="findPatient" id="findPatient" value="findPatient" title="findPatient" onclick="findPatients()"></td>
</tr>
</table>
...
<tr>
<td>Slot Date</td>
<td><input type="text" name="slot_date" id="slot_date" placeholder="dd/mm/yyyy" /></td>
</tr>
<tr>
<td></td>
<td><input type="button" name="GetAvailability" id="GetAvailability" title="GetAvailability" value="GetAvailability" onclick="getAvailability()"/></td>
</tr>
<tr>
<td>Slot Time</td>
