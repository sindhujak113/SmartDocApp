...
<input name="userId" class="form-login" title="Username" placeholder="User Name" value="" size="30" maxlength="50" />
</div>
...
New User?  <a href="userenrollment.jsp" style="margin-left:30px;">Register Here</a>
</span>
<br />
<br />
